...
\begin{frame}[shrink=10]{$\beta$-VAE: compresión inteligente de la conectividad}
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      ...
      \vspace{0.1cm}
      {\small \textbf{$\beta$-VAE:} $\beta$ pondera reconstrucción vs.\ regularización del latente.\\
      $\beta \to 0$ \highlight{recupera el AE clásico}.}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}[scale=0.82, transform shape,
        ...
        \node[below=0.5cm of z, font=\tiny] (eps) {muestreo};
        ...
        \node[above=0.05cm of z, font=\tiny\itshape] {parte probabilística};
      \end{tikzpicture}
      \shorthandon{>}
...
\begin{frame}{Discusión}
  \begin{itemize}
    ...
    \vspace{0.3cm}
    \item La cohorte \highlight{latinoamericana} es multi-sitio y multi-país: más heterogénea, pero más realista
...
\begin{frame}{Limitaciones y próximos pasos}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \textbf{Limitación}
      \begin{itemize}
        \item Cohorte modesta para brain age
        \item Heterogeneidad multi-sitio
        \item Atlas AAL relativamente grueso
        \item Sin comparación end-to-end
        \item Búsqueda limitada del $\beta$-VAE
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Próximo paso}
      \begin{itemize}
        \item Más sujetos, sobre todo CN
        \item Armonización (ComBat)
        \item Atlas de mayor resolución
        \item GNN / 3D CNN
        \item Más trials y espacios de búsqueda
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Conclusiones}
  \begin{enumerate}
    \item Pipeline multimodal (FC + T1w) con MAE de \highlight{5,62 años}; con educación y sitio: \highlight{MAE 5,17}

    \vspace{0.35cm}
    \item FC y T1w son \highlight{complementarias}; la reducción de dimensionalidad es clave frente a FC crudo

    \vspace{0.35cm}
    \item CN-only + demográficos: gaps positivas en AD y FTD; prometedor como biomarcador, pero requiere más controles y mejor control de heterogeneidad

    \vspace{0.35cm}
    \item Evaluado en una cohorte \highlight{latinoamericana multicéntrica}, poco representada en la literatura
  \end{enumerate}
\end{frame}
